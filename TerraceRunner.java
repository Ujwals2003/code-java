class TerraceRunner {
    public static void main(String[] args) {
        ...
        System.out.println("Terrace 1 is an abandoned rooftop space with potential for transformation.");
        ...
        terrace2.height = 12;
        System.out.println("\nTerrace 2 is a beautiful urban garden oasis high above the city streets.");
