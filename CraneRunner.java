class CraneRunner {
    public static void main(String[] args) {
        ...
        System.out.println("Crane 1 is an old construction equipment resting in a forgotten yard.");
        ...
        crane2.height = 30;
        System.out.println("\nCrane 2 is a powerful mobile crane ready for a major construction project.");
